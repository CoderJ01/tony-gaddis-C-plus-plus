 ...
 * Author: Joshua Jones
 *
 * Created on February 12, 2020 5:49 PM
...
int main(int argc, char** argv) {
    ...
    sumPtP2 == max ? player = "Player 2":
                     player = "Player 3";
    /*
    sumPtP1 < sumPtP2 && sumPtP1 < sumPtP3 ? sumPtP1 = min:
    sumPtP2 < sumPtP1 && sumPtP2 < sumPtP3 ? sumPtP2 = min:
                                             sumPtP3 = min;
    
    sumPtP1 == min ? potato = "Player 1":
    sumPtP2 == min ? potato = "Player 2":
                     potato = "Player 3";
    
    if((sumPtP1 < sumPtP2 && sumPtP1 > sumPtP3) || (sumPtP1 > sumPtP2 && sumPtP1 < sumPtP3)) sumPtP1 = mid;
    if((sumPtP2 < sumPtP1 && sumPtP2 > sumPtP3) || (sumPtP2 > sumPtP1 && sumPtP2 < sumPtP3)) sumPtP2 = mid;
    if((sumPtP3 < sumPtP1 && sumPtP3 > sumPtP2) || (sumPtP3 > sumPtP1 && sumPtP3 < sumPtP2))sumPtP3 = mid;
                                                                                                
    
    sumPtP1 == mid ? gamer = "Player 1":
    sumPtP2 == mid ? gamer = "Player 2":
                     gamer = "Player 3"; */
